...
Process done, we will need to promote our server to be the DC controller. 

## Configuration of the AD domain

For this configuration, follow these steps:
...
- Tick the `new forest` option and add a name in the *XXXX.YYYY* format:
...
To open it, execute the *MMC.exe* and follow the steps (follow the red squares on the images) :
