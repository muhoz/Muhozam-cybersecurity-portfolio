...
I used to be a client of VMWare and Virtual Box but after discovering Hyper-V and try it, i prefer to use this solution as an Hypervisor for my VMs.
...
- After this window will shown, scroll until you find Hyper V and check all the box related
...
- On Hyper-V Manager, on your right, choose `New -> Virtual Machine Wizard`
...
The installation done, the VM will restart and ask you to enter the login (i used `Administrator`) and choose your own password. 
Let Windows finish to start and all should be ok.
...
Let's start.
To create the two interfaces, we will go on the right of the Hyper-V Manager and open the `Virtual Switch Manager`

<img width="237" alt="network_cards_interface" src="https://github.com/user-attachments/assets/6b11177a-2adf-464a-b3d2-7039fa965722">

In the window, create the two interfaces, one named **External Switch** as an External type (connect it to the wifi card directly) and another **Private Switch** as a Private type.
...
<img width="482" alt="pfsense_view" src="https://github.com/user-attachments/assets/13de2bf3-cd50-4e93-afa8-64e16c48b1d6">
...
<img width="299" alt="DC_network_configurations" src="https://github.com/user-attachments/assets/0ace7ff8-0f09-4d31-bc9b-fdfd1d735818">
...
<img width="86" alt="internet_DC_access" src="https://github.com/user-attachments/assets/e9bc971b-5980-4e28-98da-201c3e12b789">
